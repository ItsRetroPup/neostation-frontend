...
/** Hosts the secondary/Now Playing Flutter entry point on the default display. */
class SecondaryScreenActivity : FlutterActivity() {
    companion object {
        ...
        val isActive: Boolean get() = activeInstance?.get() != null

        fun closeForPrimaryDisplayChange() {
