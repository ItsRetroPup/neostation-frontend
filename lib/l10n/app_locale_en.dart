...
const Map<String, dynamic> appLocaleEn = {
  ...
  AppLocale.raGlobalLeaderboards: 'Per-game leaderboards and the top ten',
  ...
  AppLocale.raFilterCompleted: 'Completed',
  ...
  AppLocale.raErrorLoadTopTen: 'Error loading top ten: {error}',
