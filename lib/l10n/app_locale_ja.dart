...
const Map<String, dynamic> appLocaleJa = {
  ...
  AppLocale.raGlobalLeaderboards: 'ゲーム別リーダーボードと個人順位',
  AppLocale.raGameplayHistory: '最近のゲームと実績の進捗',
  ...
  AppLocale.raStanding: '自分の順位',
  AppLocale.raStandingPill: '順位 #{rank} · 上位 {percent}',
  AppLocale.raUnranked: '未ランキング',
  AppLocale.raYourRank: '順位: {rank}',
  AppLocale.raYourPoints: 'ポイント: {points}',
  AppLocale.raUserType: '{type}',
  AppLocale.raCasual: 'カジュアル',
  AppLocale.raYourGamesLeaderboards: '自分のゲームのリーダーボード',
  AppLocale.raNoLeaderboardGames: 'リーダーボードのあるゲーム履歴はありません',
  AppLocale.raLeaderboardSignIn: 'このゲームのリーダーボードを見るにはサインインしてください。',
  AppLocale.raLeaderboardNoLeaderboards: 'このゲームにはリーダーボードがありません',
  AppLocale.raLeaderboardNoEntries: 'エントリーはまだありません',
  AppLocale.raLeaderboardEntries: 'エントリー',
  AppLocale.raLeaderboardTopEntry: 'トップ: {user} · {score}',
  AppLocale.raLeaderboardYourEntry: 'あなたのエントリー',
  AppLocale.raLeaderboardFormat: '形式: {format}',
  AppLocale.raLeaderboardRankAscending: '低いスコアほど上位',
  AppLocale.raLeaderboardRankDescending: '高いスコアほど上位',
  AppLocale.raGamesHeaderHint: 'プレイ済み＋進行状況のあるゲーム',
  AppLocale.raFilterMastered: 'マスター済み',
  AppLocale.raFilterBeaten: '攻略済み',
  ...
  AppLocale.raNoBeatenYet: '攻略済みのゲームはまだありません',
  ...
  AppLocale.raErrorLoadLeaderboards: 'リーダーボードの読み込みエラー: {error}',
  AppLocale.raErrorLoadLeaderboardEntries: 'リーダーボードエントリーの読み込みエラー: {error}',
