...
const Map<String, dynamic> appLocaleKo = {
  ...
  AppLocale.raGlobalLeaderboards: '게임별 리더보드와 개인 순위',
  AppLocale.raGameplayHistory: '최근 게임과 업적 진행 상황',
  ...
  AppLocale.raStanding: '내 순위',
  AppLocale.raStandingPill: '순위 #{rank} · 상위 {percent}',
  AppLocale.raUnranked: '순위 없음',
  AppLocale.raYourRank: '순위: {rank}',
  AppLocale.raYourPoints: '포인트: {points}',
  AppLocale.raUserType: '{type}',
  AppLocale.raCasual: '캐주얼',
  AppLocale.raYourGamesLeaderboards: '내 게임 리더보드',
  AppLocale.raNoLeaderboardGames: '리더보드 활동이 있는 게임이 없습니다',
  AppLocale.raLeaderboardSignIn: '이 게임의 리더보드를 보려면 로그인하세요.',
  AppLocale.raLeaderboardNoLeaderboards: '이 게임에는 리더보드가 없습니다',
  AppLocale.raLeaderboardNoEntries: '아직 항목이 없습니다',
  AppLocale.raLeaderboardEntries: '항목',
  AppLocale.raLeaderboardTopEntry: '최고 기록: {user} · {score}',
  AppLocale.raLeaderboardYourEntry: '내 기록',
  AppLocale.raLeaderboardFormat: '형식: {format}',
  AppLocale.raLeaderboardRankAscending: '낮은 점수가 더 높은 순위입니다',
  AppLocale.raLeaderboardRankDescending: '높은 점수가 더 높은 순위입니다',
  AppLocale.raGamesHeaderHint: '플레이한 게임 + 진행 중인 게임',
  AppLocale.raFilterMastered: '마스터함',
  AppLocale.raFilterBeaten: '클리어함',
  AppLocale.raGamesEndOfList: '기록의 모든 게임을 불러왔습니다',
  AppLocale.raGamesEmpty: '아직 게임 활동이 없습니다',
  AppLocale.raErrorLoadGames: '게임 불러오기 오류: {error}',
  AppLocale.raHardcore: '하드코어',
  AppLocale.raUnlocksEndOfList: '최근 30일의 잠금 해제가 모두 표시되었습니다',
  AppLocale.raUnlockGameNotOwned: '이 게임은 라이브러리나 RomM에 없습니다',
  ...
  AppLocale.raNoBeatenYet: '아직 클리어한 게임이 없습니다',
  ...
  AppLocale.raErrorLoadLeaderboards: '리더보드를 불러오는 중 오류: {error}',
  AppLocale.raErrorLoadLeaderboardEntries: '리더보드 항목을 불러오는 중 오류: {error}',
